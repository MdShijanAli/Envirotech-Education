                                        ...
                                        <div>
                                            ...
                                            <div className="mt-8 space-y-7">
                                                <div className="flex items-start">
                                                    ...
                                                    <span className="block ml-3 text-base text-gray-900">Newtown-7 no, Dinajpur Sadar, Dinajpur</span>
                                                </div>
                                                ...
                                                <div className="flex items-start">
                                                    ...
                                                    <span className="block ml-3 text-base text-gray-900"> freelancershijan@gmail.com </span>
                                                </div>
                                                ...
                                                <div className="flex items-start">
                                                    ...
                                                    <div className="ml-3">
                                                        <span className="block text-base text-gray-900"> (+880) 15712-61165 </span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
